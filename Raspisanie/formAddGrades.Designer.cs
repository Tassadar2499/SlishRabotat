namespace Raspisanie
{
	partial class FormAddGrades
	{
		...
		private void InitializeComponent()
		{
			...
			this.classesCheckedList.Size = new System.Drawing.Size(522, 424);
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(528, 304);
			...
			this.label1.Text = "Кликай - \"Сохранить классы\", а затем двойной клик по каждому из классов, чтобы ус" +
    "тановить предметы";
